...
<div class="main">
    <div class="main-form">
        <form action="zhuce" id="form" method="post">
            <div class="form-content">
                <div class="phone-res">
                <div class="form-group">
                        <label for="userName">注册邮箱</label>
                        <div class="input-group">
                            <input id="userName" type="text" name="email" placeholder="请输入邮箱号码"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="pwd" type="password" name="password" placeholder="请输入登录密码"/>
                            <em></em>
                        </div>
                    </div>
