...
<body>
	...
	if(request.getAttribute("login_failed")!=null){
	 ...
	 <p><%=str%> </p>
	 <div class="field">
			<input type="text" id="username" placeholder="请输入您的邮箱账号" name="email">
		</div>
		<div class="field">
			<input type="password" id="username" placeholder="请输入您的原密码" name="password">
		</div>
		<div class="field">
			<input type="password" id="password" placeholder="请输入您的新密码"name="password1">
		</div>
		<div class="save_div">	
			<span id="span1">
